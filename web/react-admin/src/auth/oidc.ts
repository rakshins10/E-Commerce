/**
 * OIDC wiring for the React back office.
 *
 * Its OWN Keycloak client (`admin-react`), separate from the storefront's. Two clients means two
 * redirect-URI allow-lists, so a redirect misconfiguration on the shop cannot be used to obtain a
 * token that the back office would accept.
 *
